      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Leading innovation and academic excellence at RKDF University
          </p>
        </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-3xl shadow-xl p-8 sticky top-24">
              ...
              <div className="text-center mb-6">
                <h2 className="text-2xl font-bold text-gray-900 mb-1">Prof. Vijay K. Agrawal</h2>
              ...
              <div className="space-y-3 pt-6 border-t border-gray-100">
                <a href="mailto:vc@rkdf.ac.in" className="flex items-center space-x-3 text-gray-600 hover:text-[#4a90c8] transition-colors group">
                  <div className="w-10 h-10 bg-blue-50 rounded-xl flex items-center justify-center group-hover:bg-blue-100 transition-colors">
                    <Mail className="w-5 h-5 text-[#4a90c8]" />
                  </div>
                  <span className="text-sm">vc@rkdf.ac.in</span>
                </a>
            ...
            <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
              <div className="p-8 md:p-12">
                ...
                <div className="mt-10 pt-8 border-t border-gray-200">
                  ...
                  <p className="text-2xl font-bold text-gray-900 mb-1">Prof. Vijay K. Agrawal</p>
