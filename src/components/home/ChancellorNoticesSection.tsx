        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
          <div className="grid lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-4">
              <div className="relative max-w-sm mx-auto lg:max-w-none">
                ...
                <div className="relative">
                  ...
                  <div className="absolute -top-4 -left-4 sm:-top-6 sm:-left-6 w-12 h-12 sm:w-16 sm:h-16 bg-[#4a90c8] rounded-full flex items-center justify-center shadow-2xl z-10">
                    <Quote className="w-6 h-6 sm:w-8 sm:h-8 text-white" fill="currentColor" />
                  </div>
            ...
            <div className="lg:col-span-8 text-black space-y-4 sm:space-y-6">
              ...
              {/* Name and Title */}
              <div>
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-2 text-black tracking-tight">Dr. Sadhna Kapoor</h2>
                <div className="flex items-center gap-2 sm:gap-3 text-lg sm:text-xl text-[#4a90c8] font-semibold mb-2">
                  <div className="w-8 sm:w-12 h-0.5 bg-[#4a90c8]"></div>
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 sm:gap-3 bg-[#4a90c8] hover:bg-[#5a9fd8] hover:text-black text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl text-sm sm:text-base font-bold transition-all duration-300 group shadow-xl hover:shadow-2xl hover:shadow-blue-500/20 hover:scale-105"
              >
