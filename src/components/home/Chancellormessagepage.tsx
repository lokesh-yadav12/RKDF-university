          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-3xl shadow-xl p-8 sticky top-24">
              ...
              <div className="text-center mb-6">
                <h2 className="text-2xl font-bold text-gray-900 mb-1">Dr. Sadhna Kapoor</h2>
              ...
              <div className="space-y-3 pt-6 border-t border-gray-100">
                <a href="mailto:chancellor@rkdf.ac.in" className="flex items-center space-x-3 text-gray-600 hover:text-[#4a90c8] transition-colors group">
                  <div className="w-10 h-10 bg-blue-50 rounded-xl flex items-center justify-center group-hover:bg-blue-100 transition-colors">
                    <Mail className="w-5 h-5 text-[#4a90c8]" />
                  </div>
                  <span className="text-sm">chancellor@rkdf.ac.in</span>
                </a>
                ...
                <div className="flex items-center space-x-3 text-gray-600">
                  ...
                  <span className="text-sm">RKDF University, Bhopal</span>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="p-8 md:p-12">
                ...
                <div className="prose prose-lg max-w-none">
                  <div className="text-gray-700 space-y-6 leading-relaxed">
                    <p className="text-lg">
                      Not enough educational facilities are available for the people of this region. Keeping this in view, <strong className="text-gray-900">RKDF University was established with the vision to provide quality education</strong> and create opportunities for holistic development.
                    </p>
                ...
                <div className="mt-10 pt-8 border-t border-gray-200">
                  ...
                  <p className="text-2xl font-bold text-gray-900 mb-1">Dr. Sadhna Kapoor</p>
