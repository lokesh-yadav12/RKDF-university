...
export default function Footer() {
  const quickLinks1 = [
    { name: 'RKDF Online Knowledge Portal', href: '#' },
          ...
          <div>
            ...
            <ul className="space-y-3 text-slate-400">
              <li className="flex items-start space-x-2">
                ...
                <span>
                  RKDF University, Airport Rd, Abbas Nagar, Gandhi Nagar, Bhopal, Madhya Pradesh, India<br />
                  Pin Code - 462033
                </span>
              </li>
              ...
              <li className="flex items-center space-x-2">
                ...
                <span>rkdfuniversitybpl@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-slate-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 space-y-4 md:space-y-0">
            <p className="text-slate-400 text-sm w-full text-center  gap-8">
              © 2024 - RKDF University | All ® rights reserved | 
