...
// 					{/* Desktop Menu */}
// 					<div className="hidden lg:flex text-sm font-semibold items-center gap-0.5 xl:gap-1">
// 						{navLinks.map((link) => (
// 							<div
// 								key={link.label}
...
// 								{link.hasDropdown ? (
// 									<>
// 										<button className="text-black hover:bg-[#5a9fd8] px-1 md:px-2 xl:px-2 py-2 rounded font-medium transition-colors flex items-center gap-0.5 whitespace-nowrap">
...
// 									<Link
// 										to={link.href || '#'}
// 										className="text-black hover:bg-[#5a9fd8] hover:text-black px-2 xl:px-3 py-2 rounded font-medium transition-colors block whitespace-nowrap"
// 									>
// 										{link.label}
// 									</Link>
// 								)}
...
// 						className="lg:hidden p-2 rounded-lg bg-[#4a90c8] hover:bg-[#5a9fd8] transition-colors"
// 					>
// 						{isMobileMenuOpen ? (
					...
					<div className="hidden md:flex text-md font-semibold text-start space-x-1 sm:pl-6">
						{navLinks.map((link) => (
							...
							>
								{link.hasDropdown ? (
									<>
										<button className="text-black hover:bg-[#5a9fd8] px-1 md:px-2 py-2 rounded font-medium transition-colors flex items-center space-x-1">
											<span>{link.label}</span>
											<ChevronDown className="w-4 h-4" />
										</button>
									...
									<Link
										to={link.href || '#'}
										className="text-black hover:bg-[#5a9fd8] hover:text-black px-2 py-2 rounded font-medium transition-colors block"
									>
										{link.label}
									</Link>
								)}
